...
namespace Unity.Services.Authentication.Generated
{
    ...
    internal interface IPlayerNamesApi : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<Player>> GetNameAsync(string playerId,
            bool? autoGenerate = default(bool?), bool? showMetadata = default(bool?),
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Player</returns>
        System.Threading.Tasks.Task<ApiResponse<Player>> UpdateNameAsync(string playerId,
    ...
    internal partial class PlayerNamesApi : IPlayerNamesApi
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Player</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Player>> GetNameAsync(string playerId,
            bool? autoGenerate = default(bool?), bool? showMetadata = default(bool?),
            System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (playerId == null)
            {
                throw new ApiException(ApiExceptionType.InvalidParameters,
                    "Missing required parameter 'playerId' when calling PlayerNamesApi->GetName");
            }
            ...
            localRequestOptions.PathParameters.Add("playerId",
                ApiUtils.ParameterToString(Configuration, playerId)); // path parameter
            if (autoGenerate != null)
            {
                localRequestOptions.QueryParameters.Add(ApiUtils.ParameterToMultiMap(Configuration, "", "autoGenerate",
                    autoGenerate));
            }

            if (showMetadata != null)
            {
                localRequestOptions.QueryParameters.Add(ApiUtils.ParameterToMultiMap(Configuration, "", "showMetadata",
                    showMetadata));
            }
            ...
            if (!string.IsNullOrEmpty(this.Configuration.AccessToken) &&
                !localRequestOptions.HeaderParameters.ContainsKey("Authorization"))
            {
                localRequestOptions.HeaderParameters.Add("Authorization", "Bearer " + this.Configuration.AccessToken);
            }

            // make the HTTP request
            return await this.Client.GetAsync<Player>("/names/{playerId}", localRequestOptions, this.Configuration,
                cancellationToken);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Player</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Player>> UpdateNameAsync(string playerId,
            UpdateNameRequest updateNameRequest,
            System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'playerId' is set
            ...
            {
                throw new ApiException(ApiExceptionType.InvalidParameters,
                    "Missing required parameter 'playerId' when calling PlayerNamesApi->UpdateName");
            }
            ...
            {
                throw new ApiException(ApiExceptionType.InvalidParameters,
                    "Missing required parameter 'updateNameRequest' when calling PlayerNamesApi->UpdateName");
            }
            ...
            // make the HTTP request
            return await this.Client.PostAsync<Player>("/names/{playerId}", localRequestOptions, this.Configuration,
                cancellationToken);
        }
    }
}